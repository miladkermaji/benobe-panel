<div>
  <div class="modal-header">
    <h6 class="modal-title fw-bold text-dark" id="endVisitModalCenterTitle">توضیحات درمان</h6>
  ...
  <div class="modal-body">
    ...
    <button class="btn my-btn-primary w-100 mt-3 shadow-sm end-visit-btn" wire:click="endVisit">ثبت</button>
  </div>
</div>
