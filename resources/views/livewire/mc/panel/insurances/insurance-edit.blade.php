  ...
  <div class="card shadow-lg border-0 rounded-2 overflow-hidden" style="background: #ffffff;">
    <div
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <h5 class="mb-0 fw-bold text-shadow">ویرایش بیمه</h5>
      </div>
    ...
    <div class="card-body p-3">
            ...
            <form wire:submit="update">
              <div class="row g-3">
                @if ($currentInsurance)
                  <div class="col-12">
                    <div class="alert alert-info">
                      <h6 class="alert-heading">اطلاعات بیمه فعلی</h6>
                      <div class="mt-2">
                        <strong>بیمه فعلی:</strong> {{ $currentInsurance->name }}
                      </div>
                      @if ($currentInsurance->calculation_method)
                        <div class="mt-1">
                          <strong>روش محاسبه:</strong> {{ $currentInsurance->calculation_method }}
                        </div>
                      @endif
                    </div>
                  </div>
                ...
                <div class="col-12 position-relative mt-4" wire:ignore>
                  ...
                  <label for="insurance_ids" class="form-label">انتخاب بیمه جدید *</label>
                </div>
      ...
      @else
        <div class="text-center py-4">
          ...
          <p class="text-muted mt-2 mb-0">بیمه مورد نظر یافت نشد</p>
          <a href="{{ route('mc.panel.insurances.index') }}" class="btn btn-outline-secondary mt-3">
            بازگشت به لیست
          </a>
        </div>
      @endif
