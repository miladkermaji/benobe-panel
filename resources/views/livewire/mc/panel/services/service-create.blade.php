  ...
  <div class="card shadow-lg border-0 rounded-2 overflow-hidden" style="background: #ffffff;">
          ...
          <form wire:submit="store">
            <div class="row g-3">
              ...
              <div class="col-12 position-relative mt-4" wire:ignore>
                ...
                <label for="service_ids" class="form-label">انتخاب خدمت‌ها *</label>
              </div>
    ...
    <script>
      document.addEventListener('livewire:init', function() {
        ...
        // Initialize Select2 for services (multiple)
        $('#service_ids').select2({
        ...
        // Listen for services refresh
        Livewire.on('refresh-services', (data) => {
          $('#service_ids').empty();
