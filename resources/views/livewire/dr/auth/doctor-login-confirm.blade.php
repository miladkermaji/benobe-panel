    ...
    <div class="col-md-6 login-container position-relative">
        <div class="login-card custom-rounded custom-shadow p-7">
            ...
            <form wire:submit.prevent="loginConfirm">
                ...
                <section id="resend-otp" class="mt-2 text-center"
                    style="{{ $showResendButton ? '' : 'display: none;' }}">
                ...
                <section style="font-size: 14px" class="text-danger fw-bold fs-6 mt-3 text-center" id="timer"
                    wire:ignore>
