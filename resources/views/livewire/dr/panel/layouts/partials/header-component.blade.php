<div>
  <div class="header d-flex item-center bg-white width-100 custom-border-bottom">
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="w-100">
            <div class="dropdown">
                <div class="dropdown-trigger btn h-40 w-md-300 bg-light-blue text-left d-flex justify-content-between align-items-center"
                     aria-haspopup="true" aria-expanded="false">
                    <div class="text-truncate">
                        <span class="dropdown-label">{{ $selectedClinicName }}</span>
                    </div>
                ...
                <div class="my-dropdown-menu d-none">
                    <div class="" aria-hidden="true">
                        <div class="{{ Route::is('doctors.clinic.deposit') ? 'd-none' : '' }}" aria-hidden="true">
                            <div class="d-flex align-items-center p-3 option-card {{ $selectedClinicId === null ? 'card-active' : '' }}"
                                 wire:click="selectClinic()" data-id="default">
                        ...
                        @foreach ($clinics as $clinic)
                            <div class="d-flex justify-content-between align-items-center option-card {{ $selectedClinicId == $clinic->id ? 'card-active' : '' }} {{ !$clinic->is_active ? 'inactive-clinic' : '' }}"
                                 wire:click="selectClinic({{ $clinic->id }})" data-id="{{ $clinic->id }}"
                                ...
                                <div class="d-flex align-items-center p-3 position-relative">
                                    ...
                                    <div class="d-flex flex-column mx-3">
                                        ...
                                        <span class="fw-bold d-block fs-13">{{ $clinic->province->name ?? '' }}، {{ $clinic->city->name ?? '' }}</span>
                                    </div>
                                    @if (!$clinic->is_active)
