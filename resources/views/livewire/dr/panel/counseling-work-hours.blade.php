          ...
          <div>
            ...
            <div>
              ...
              <div class="row border border-radius-11 p-3 align-items-center">
                ...
                <!-- تعداد روزهای باز تقویم و باز بودن در تعطیلات -->
                <div class="row border border-radius-11 p-3 align-items-center">
                  <div class="col-8">
                  ...
                  <div class="col-4">
                    <div class="p-1 rounded bg-white"
                      ...
                      <x-my-check :isChecked="$holidayAvailability" id="posible-appointments-inholiday"
                        day="باز بودن مطب در تعطیلات رسمی" model="holidayAvailability" />
                    </div>
                  </div>
                </div>
                <!-- امکان مشاوره آنلاین -->
                <div class="mt-3">
                  <x-my-check :isChecked="$onlineConsultation" id="posible-appointments"
                    day="امکان دریافت مشاوره آنلاین توسط کاربران وجود داشته باشد؟" model="onlineConsultation" />
                </div>
                <!-- انواع مشاوره -->
                <div class="mt-3">
                  <div class="d-flex flex-wrap justify-content-start mt-2 gap-40 bg-light p-3 counseling-types-wrapper">
                    ...
                    <x-my-check :isChecked="$has_video_counseling" id="video-counseling" day="مشاوره ویدیویی"
                      model="has_video_counseling" />
                  </div>
                </div>
                <!-- تعرفه مشاوره -->
                <div class="form-group w-100 mt-3 pb-4">
                  <div class="d-flex justify-content-between w-100">
                    ...
                    <div class="my-tooltip">
                      <x-custom-tooltip
                        title=" توجه! مبلغ هر دقیقه مکالمه در بسته های زیر پورسانت سایت میباشد 1,000 تومان
