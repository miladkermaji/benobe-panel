            ...
            <form wire:submit.prevent="twoFactorCheck">
                <div class="mb-3">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <img src="{{ asset('admin-assets/login/images/visible.svg') }}" alt="نمایش رمز"
                            class="password-toggle ms-2" style="position: absolute; left: 10px; top: 50%; transform: translateY(-50%);"
