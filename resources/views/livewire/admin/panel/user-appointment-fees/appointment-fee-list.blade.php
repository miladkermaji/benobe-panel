    ...
    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 w-100">
      <div class="d-flex flex-column flex-md-row gap-2 w-100 align-items-center justify-content-between w-100">
        <div class="d-flex align-items-center gap-3">
          <h1 class="m-0 h4 font-thin text-nowrap mb-3 mb-md-0">مدیریت هزینه‌های نوبت</h1>
        </div>
          ...
          <div class="d-flex gap-2 flex-shrink-0 justify-content-center w-100 flex-column flex-md-row">
            <div class="search-container position-relative flex-grow-1 mb-2 mb-md-0 w-100">
              <input type="text"
                ...
                wire:model.live="search" placeholder="جستجو بر اساس نام..."
            ...
            <a href="{{ route('admin.panel.user-appointment-fees.create') }}"
              class="btn btn-gradient-success rounded-1 px-3 py-1 d-flex align-items-center gap-1 w-100 w-md-auto justify-content-center justify-content-md-start">
          ...
          <table class="table table-hover w-100 m-0">
            <thead>
              <tr>
                ...
                <th class="text-center align-middle cursor-pointer" style="width: 100px;" wire:click="sortBy('status')">
                  وضعیت
                  @if ($sortField === 'status')
                    @if ($sortDirection === 'asc')
                      ↑
