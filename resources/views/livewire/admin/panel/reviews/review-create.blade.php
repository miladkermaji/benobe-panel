    ...
    <div class="card shadow-lg border-0 rounded-3 overflow-hidden">
        <div class="card-header bg-gradient-primary text-white p-3 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <h5 class="mb-0 fw-bold">افزودن نظر جدید</h5>
            </div>
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-md-6 position-relative mt-5">
                            <input type="number" wire:model="rating" class="form-control input-shiny" id="rating" min="0" max="5" step="1" placeholder=" ">
                        ...
                        <div class="col-6 col-md-6 position-relative mt-5 d-flex align-items-center">
                            <div class="form-check form-switch w-100 d-flex align-items-center">
                                ...
                                <label class="form-check-label fw-medium" for="is_approved">
                                    وضعیت: <span class="px-2 text-{{ $is_approved ? 'success' : 'danger' }}">{{ $is_approved ? 'تأیید شده' : 'تأیید نشده' }}</span>
                                </label>
                            </div>
                        </div>
