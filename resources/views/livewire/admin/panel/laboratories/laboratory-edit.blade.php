        ...
        <div class="col-12 col-md-10 col-lg-8">
          <div class="row g-4">
            ...
            <div class="col-6 col-md-6 position-relative mt-5">
              ...
              <label for="title" class="form-label">عنوان آزمایشگاه </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5" wire:ignore>
              ...
              <label for="specialty_ids" class="form-label">تخصص‌های آزمایشگاه </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5" wire:ignore>
    ...
    <label for="Daycare_centers" class="form-label">مرکز شبانه‌روزی</label>
            ...
            <div class="col-12 position-relative mt-5">
              ...
              @if ($laboratory->avatar)
                <img src="{{ Storage::url($laboratory->avatar) }}" alt="تصویر اصلی" class="mt-2"
