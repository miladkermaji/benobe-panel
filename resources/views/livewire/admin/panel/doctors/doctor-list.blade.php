      ...
      <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 w-100">
        <div class="d-flex flex-column flex-md-row gap-2 w-100 align-items-center justify-content-between">
          <div class="d-flex align-items-center gap-3">
            ...
            <h1 class="m-0 h4 font-thin text-nowrap mb-3 mb-md-0">مدیریت پزشکان</h1>
          </div>
            ...
            <div class="d-flex gap-2 flex-shrink-0 justify-content-center w-100 flex-column flex-md-row">
              <div class="search-container position-relative flex-grow-1 mb-2 mb-md-0 w-100">
                <input type="text"
                  ...
                  wire:model.live="search" placeholder="جستجو بر اساس نام، موبایل یا ایمیل..."
                ...
                <div class="note-card mb-2" x-data="{ open: false }">
                  ...
                  <div class="note-card-body px-2 py-2" x-show="open" x-transition>
                    ...
                    <div class="note-card-item d-flex justify-content-between align-items-center py-1">
                      ...
                      <span
                        class="note-card-value">{{ $item->created_at ? \Morilog\Jalali\Jalalian::fromCarbon($item->created_at)->format('Y/m/d') : '---' }}</span>
                    </div>
                    <div class="note-card-item d-flex justify-content-between align-items-center py-1">
                      <span class="note-card-label">تعرفه نوبت:</span>
                      <span class="note-card-value">رایگان</span>
                    </div>
                    <div class="note-card-item d-flex justify-content-between align-items-center py-1">
                      <span class="note-card-label">تعرفه ویزیت:</span>
                      <span class="note-card-value">رایگان</span>
                    </div>
                    <div class="note-card-item d-flex justify-content-between align-items-center py-1">
