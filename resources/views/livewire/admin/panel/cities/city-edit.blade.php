 ...
 <div class="card shadow-lg border-0 rounded-3 overflow-hidden">
  <div
   ...
   <div class="d-flex align-items-center gap-3">
    ...
    <h5 class="mb-0 fw-bold">ویرایش شهر: {{ $name }}</h5>
   </div>
   <a href="{{ route('admin.panel.cities.index', ['province_id' => $parent_id]) }}"
   ...
   <div class="row g-4">
    <div class="col-md-6 col-sm-12">
     <div class="bg-light rounded-3 p-3 shadow-sm hover:shadow-md transition-all">
      ...
      <input type="text" wire:model="name" class="form-control input-shiny" id="name" placeholder="نام شهر"
       required>
     </div>
    </div>
    <div class="col-md-6 col-sm-12">
