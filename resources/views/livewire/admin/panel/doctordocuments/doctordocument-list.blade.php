<div class="container-fluid py-2" dir="rtl" wire:init="loadDocuments">
  <div
    ...
    <div class="d-flex gap-2 flex-shrink-0 flex-wrap justify-content-center mt-md-2 buttons-container">
      <a href="{{ route('admin.panel.doctordocuments.create') }}"
                        ...
                        <tr>
                          ...
                          <td class="text-center align-middle">
                            <div class="d-flex justify-content-center gap-2">
                              ...
                              <a href="{{ route('admin.panel.doctordocuments.edit', $document->id) }}"
    ...
    document.addEventListener('livewire:init', function () {
        ...
        Livewire.on('showPreview', (event) => {
            ...
            if (imageTypes.includes(fileType)) {
                content.innerHTML = `<img src="${event.path}" class="img-fluid rounded-3" style="max-height: 500px;" alt="پیش‌نمایش مدرک">`;
            } else if (fileType === 'pdf') {
                content.innerHTML = `<iframe src="${event.path}" class="w-100 rounded-3" style="height: 500px;"></iframe>`;
                ...
                content.innerHTML = `<iframe src="${viewerUrl}" class="w-100 rounded-3" style="height: 500px;"></iframe>`;
            } else {
