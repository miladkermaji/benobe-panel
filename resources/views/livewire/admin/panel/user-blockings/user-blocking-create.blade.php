  ...
  <div class="card shadow-lg border-0 rounded-3 overflow-hidden" style="background: #ffffff;">
    <div
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <h5 class="mb-0 fw-bold text-shadow">افزودن کاربر مسدود جدید</h5>
      </div>
      <a href="{{ route('admin.panel.user-blockings.index') }}"
          ...
          <div class="row g-4">
              ...
              <select wire:model="doctor_id" class="form-select select2" id="doctor_id">
                ...
                @foreach ($doctors as $doctor)
                  <option value="{{ $doctor->id }}">
                    {{ $doctor->first_name . ' ' . $doctor->last_name . ' (' . $doctor->mobile . ')' }}</option>
                @endforeach
              </select>
            ...
            <div class="col-6 col-md-6 position-relative mt-5">
              <input type="text" wire:model="blocked_at" class="form-control jalali-datepicker text-end"
                id="blocked_at" placeholder="" data-jdp required>
            ...
            <div class="col-6 col-md-6 position-relative mt-5">
              <input type="text" wire:model="unblocked_at" class="form-control jalali-datepicker text-end"
                id="unblocked_at" placeholder="" data-jdp>
            ...
            <div class="col-6 col-md-6 position-relative mt-5 d-flex align-items-center">
              <div class="form-check form-switch w-100 d-flex align-items-center">
                ...
                <label class="form-check-label fw-medium" for="status">
                  وضعیت: <span
                    class="px-2 text-{{ $status ? 'success' : 'danger' }}">{{ $status ? 'مسدود' : 'آزاد' }}</span>
                </label>
              </div>
            </div>
          </div>
