  ...
  <div
    ...
    <div class="d-flex gap-2 flex-shrink-0 flex-wrap justify-content-center mt-md-2 buttons-container">
      <a href="{{ route('admin.panel.sub-users.create') }}"
        class="btn btn-gradient-success rounded-pill px-4 d-flex align-items-center justify-content-center gap-2">
                      ...
                      <tbody>
                        @forelse ($doctor->subUsers as $index => $subUser)
                          <tr>
                            ...
                            <td class="align-middle">{{ $subUser->user->first_name . ' ' . $subUser->user->last_name }}
                            </td>
                    ...
                    @forelse ($doctor->subUsers as $index => $subUser)
                      <div class="card shadow-sm mb-3 border-0">
                        <div class="card-body p-3">
                          ...
                          <div class="mb-2">
                            <small class="text-muted d-block mb-1">نام کاربر:</small>
                            <span
                              class="fw-medium">{{ $subUser->user->first_name . ' ' . $subUser->user->last_name }}</span>
                          </div>
                          <div class="mb-3">
                            <small class="text-muted d-block mb-1">موبایل:</small>
                            <span class="fw-medium">{{ $subUser->user->mobile }}</span>
                          </div>
