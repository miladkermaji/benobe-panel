                        ...
                        <form wire:submit.prevent="save">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input wire:model="title" type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="عنوان استوری را وارد کنید">
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea wire:model="description" class="form-control @error('description') is-invalid @enderror" id="description" rows="4" placeholder="توضیحات استوری را وارد کنید"></textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input wire:model="order" type="number" class="form-control @error('order') is-invalid @enderror" id="order" placeholder="0" min="0">
                                                @error('order')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input wire:model="duration" type="number" class="form-control @error('duration') is-invalid @enderror" id="duration" placeholder="مدت زمان" min="1">
                                                @error('duration')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input wire:model="live_start_time" type="datetime-local" class="form-control @error('live_start_time') is-invalid @enderror" id="live_start_time">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input wire:model="live_end_time" type="datetime-local" class="form-control @error('live_end_time') is-invalid @enderror" id="live_end_time">
                                                        @error('live_end_time')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header">
                                            <h6 class="mb-0">رسانه فعلی</h6>
                                        </div>
                                        <div class="card-body">
                                            @if($type === 'image')
                                                <img src="{{ Storage::url($current_media_path) }}" class="img-fluid rounded mb-2" alt="رسانه فعلی">
                                            @else
                                            ...
                                            @endif
                                            <button type="button" wire:click="deleteMedia" class="btn btn-sm btn-outline-danger w-100" onclick="return confirm('آیا از حذف فایل رسانه اطمینان دارید؟')">
                                                <i class="fas fa-trash"></i> حذف رسانه
                                            </button>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header">
                                            <h6 class="mb-0">تصویر بندانگشتی فعلی</h6>
                                        </div>
                                        <div class="card-body">
                                            <img src="{{ Storage::url($current_thumbnail_path) }}" class="img-fluid rounded mb-2" alt="تصویر بندانگشتی فعلی">
                                            <button type="button" wire:click="deleteThumbnail" class="btn btn-sm btn-outline-danger w-100" onclick="return confirm('آیا از حذف تصویر بندانگشتی اطمینان دارید؟')">
                                                <i class="fas fa-trash"></i> حذف تصویر بندانگشتی
                                            </button>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <select wire:model="owner_type" class="form-select @error('owner_type') is-invalid @enderror" id="owner_type">
                                            ...
                                            @if($owner_type === 'doctor')
                                                <div class="mb-3">
                                                    ...
                                                    <select wire:model="doctor_id" class="form-select @error('doctor_id') is-invalid @enderror" id="doctor_id">
                                            ...
                                            @if($owner_type === 'medical_center')
                                                <div class="mb-3">
                                                    <label for="medical_center_id" class="form-label">انتخاب مرکز درمانی <span class="text-danger">*</span></label>
                                                    <select wire:model="medical_center_id" class="form-select @error('medical_center_id') is-invalid @enderror" id="medical_center_id">
                                            ...
                                            @if($owner_type === 'manager')
                                                <div class="mb-3">
                                                    ...
                                                    <select wire:model="manager_id" class="form-select @error('manager_id') is-invalid @enderror" id="manager_id">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header">
                                            <h6 class="mb-0">آپلود فایل‌های جدید</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input wire:model="media_file" type="file" class="form-control @error('media_file') is-invalid @enderror" id="media_file" 
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input wire:model="thumbnail_file" type="file" class="form-control @error('thumbnail_file') is-invalid @enderror" id="thumbnail_file" accept="image/*">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> به‌روزرسانی استوری
                                </button>
                            </div>
                        </form>
                    </div>
