 ...
 <div class="card shadow-lg border-0 rounded-3 overflow-hidden">
  <div
   ...
   <div class="d-flex align-items-center gap-3">
    ...
    <h5 class="mb-0 fw-bold">گالری تصاویر مرکز تصویربرداری: {{ $imaging_center->name }}</h5>
   </div>
       ...
       <div class="col-md-3 col-sm-6">
        <div class="card shadow-sm position-relative">
         <img src="{{ Storage::url($gallery->image_path) }}" class="card-img-top"
          alt="{{ $gallery->caption ?? 'تصویر مرکز تصویربرداری' }}" style="height: 150px; object-fit: cover;">
