    ...
    <div class="card shadow-lg border-0 rounded-3 overflow-hidden" style="background: #ffffff;">
        <div class="card-header bg-gradient-primary text-white p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <h5 class="mb-0 fw-bold text-shadow">افزودن مرکز تصویربرداری جدید</h5>
            </div>
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-md-6 position-relative mt-5">
                            ...
                            <label for="name" class="form-label">نام مرکز تصویربرداری</label>
                        </div>
                        <div class="col-6 col-md-6 position-relative mt-5">
                        ...
                        <div class="col-6 col-md-6 position-relative mt-5">
                            <input type="number" wire:model="service_fee" class="form-control" id="service_fee" placeholder=" " step="0.01">
                            <label for="service_fee" class="form-label">هزینه خدمات</label>
                        </div>
                        <div class="col-6 col-md-6 position-relative mt-5">
