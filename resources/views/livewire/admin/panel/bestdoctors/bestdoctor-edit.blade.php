<div class="container-fluid py-4" dir="rtl">
    <div class="card shadow-lg border-0 rounded-3 overflow-hidden" style="background: #ffffff;">
        <div class="card-header bg-gradient-primary text-white p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <a href="{{ route('admin.panel.bestdoctors.index') }}"
                        ...
                        <div class="col-6 position-relative mt-5 d-flex align-items-center">
                            <div class="form-check form-switch w-100 d-flex align-items-center">
                                ...
                                <label class="form-check-label fw-medium" for="best_doctor">
                                    بهترین پزشک: <span class="px-2 text-{{ $best_doctor ? 'success' : 'danger' }}">{{ $best_doctor ? 'بله' : 'خیر' }}</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-6 position-relative mt-5 d-flex align-items-center">
                            <div class="form-check form-switch w-100 d-flex align-items-center">
                                ...
                                <label class="form-check-label fw-medium" for="best_consultant">
                                    بهترین مشاور: <span class="px-2 text-{{ $best_consultant ? 'success' : 'danger' }}">{{ $best_consultant ? 'بله' : 'خیر' }}</span>
                                </label>
                            </div>
                        </div>
    ...
    <style>
        ...
        .select2-container--default .select2-selection--single { height: 48px; border: 1px solid #e5e7eb; border-radius: 8px; background: #fafafa; }
