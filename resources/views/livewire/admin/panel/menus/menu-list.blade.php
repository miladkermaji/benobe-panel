            ...
            <div class="form-check form-check-inline">
              <div class="container-fluid py-2" dir="rtl" wire:init="loadmenus">
                <div
                  ...
                  <select class="form-select form-select-sm w-auto" style="min-width: 120px;"
                    wire:model.live="statusFilter">
                    <option value="">همه وضعیت‌ها</option>
                    <option value="active">فقط فعال</option>
                    <option value="inactive">فقط غیرفعال</option>
                  ...
                  <div class="d-flex gap-2 flex-shrink-0 flex-wrap justify-content-center mt-md-2 buttons-container">
                    <select class="form-select form-select-sm" wire:model.live="groupAction">
                      <option value="">عملیات گروهی</option>
                      <option value="delete">حذف انتخاب‌شده‌ها</option>
                      <option value="status_active">تغییر به فعال</option>
                      <option value="status_inactive">تغییر به غیرفعال</option>
                    </select>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" wire:model.live="applyToAllFiltered"
                        id="applyToAllFiltered">
                      <label class="form-check-label" for="applyToAllFiltered">اعمال روی همه نتایج فیلترشده</label>
                    </div>
                    <button class="btn btn-sm btn-primary" wire:click="executeGroupAction">اجرا</button>
                    <a href="{{ route('admin.panel.menus.create') }}"
                            ...
                            @if ($readyToLoad)
                              @forelse ($menus as $index => $item)
                                <tr>
                                  ...
                                  <td>{{ $item->name }}</td>
                                  <td class="text-truncate" style="max-width: 200px;" title="{{ $item->url }}">
                                    {{ $item->url }}
                                  </td>
                                  <td>
                                    @if ($item->icon)
                                      <img src="{{ asset('storage/' . $item->icon) }}" alt="آیکون"
                            ...
                            <div class="card m-3 border-0 shadow-sm">
                              <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                  ...
                                  <span
                                    class="fw-medium">{{ $item->parent ? $item->parent->name : 'دسته اصلی' }}</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
