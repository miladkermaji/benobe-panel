        ...
        <div class="bg-light p-4 rounded-xl shadow-sm animate__animated animate__fadeInUp">
            <div class="row g-4 align-items-center">
                <div class="col-md-4 col-sm-12">
                    ...
                    @error('newEmail') <span class="text-danger d-block mt-2 text-sm">{{ $message }}</span> @enderror
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="input-group align-items-center">
                        <span class="input-group-text bg-white border-0 rounded-start-xl flex-shrink-0"
                        ...
                        <input type="text"
                            class="form-control input-modern border-0 shadow-none rounded-end-xl flex-grow-1"
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-bordered table-hover w-100 m-0 rounded-xl">
                        <thead class="glass-header text-white">
                            <tr>
                                <th class="text-center align-middle py-3"><input type="checkbox"
                                        wire:model.live="selectAll" class="py-2"></th>
                            ...
                            @forelse ($members as $index => $member)
                                <tr class="animate__animated animate__fadeIn">
                                    <td class="align-middle text-center"><input type="checkbox"
                                            wire:model.live="selectedMembers" value="{{ $member->id }}" class="py-2"></td>
                                    <td class="align-middle text-center">{{ $members->firstItem() + $index }}</td>
                                    <td class="align-middle text-center">
                                        @if($editId === $member->id)
                                            <input type="email" class="form-control input-modern border-0 shadow-none"
