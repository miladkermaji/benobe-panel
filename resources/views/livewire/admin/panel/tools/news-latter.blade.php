                ...
                <div class="card border-0 shadow-sm animate__animated animate__fadeIn">
                  <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      ...
                      <span class="text-muted">#{{ $members->firstItem() + $index }}</span>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch"
                          wire:click="toggleStatus({{ $member->id }})" @checked($member->is_active)>
                        <label class="form-check-label">{{ $member->is_active ? 'فعال' : 'غیرفعال' }}</label>
                      </div>
              ...
              <div class="col-12">
                <div class="card border-0 shadow-sm">
                  <div class="card-body p-5 text-center">
                    ...
                    <p class="text-muted fw-medium text-lg mb-0">هیچ عضوی یافت نشد.</p>
                  </div>
                </div>
              </div>
            @endforelse
