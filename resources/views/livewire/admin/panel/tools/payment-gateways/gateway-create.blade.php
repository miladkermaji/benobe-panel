                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name" class="form-label fw-bold">نام سیستم درگاه <span class="text-danger">*</span></label>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="settings" class="form-label fw-bold">تنظیمات درگاه (JSON) <span class="text-danger">*</span></label>
