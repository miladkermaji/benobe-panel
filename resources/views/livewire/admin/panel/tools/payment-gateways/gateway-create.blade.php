          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="form-group">
                <label for="name" class="form-label fw-bold">نام سیستم درگاه <span
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="title" class="form-label fw-bold">عنوان درگاه <span class="text-danger">*</span></label>
                <input type="text" wire:model="title" id="title" class="form-control rounded-2"
                  placeholder="مثال: درگاه زرین‌پال" required>
                @error('title')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
            ...
            <div class="col-12">
              <div class="form-group">
                <label for="settings" class="form-label fw-bold">تنظیمات درگاه (JSON) <span
                    class="text-danger">*</span></label>
                <textarea dir="ltr" wire:model="settings" id="settings" class="form-control rounded-2" rows="8"
                  placeholder='{"merchant_id": "xxxx", "sandbox": true}' required
                  style="resize: vertical; font-family: 'Courier New', monospace; font-size: 0.9rem;"></textarea>
                @error('settings')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
                <small class="text-muted mt-1 d-block">تنظیمات درگاه را به صورت JSON معتبر وارد کنید</small>
              </div>
            </div>

            <div class="col-12 text-end mt-3">
              <button type="submit" class="btn my-btn-primary rounded-pill px-4 py-2 d-flex align-items-center gap-2">
