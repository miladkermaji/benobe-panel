<div class="container-fluid py-4" dir="rtl">
  ...
  <header class="glass-header p-4 rounded-xl mb-5 shadow-lg animate__animated animate__fadeIn">
    <div class="d-flex align-items-center justify-content-start gap-3 flex-nowrap">
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" class="animate-pulse">
    ...
    <div class="col-lg-9 col-md-8 col-sm-12">
      ...
      @endif
          ...
          <div class="form-group mb-4">
            ...
            <textarea class="form-control input-modern w-100" wire:model="newTemplate" rows="10"
              id="newTemplateEditor"></textarea>
      ...
      <div class="row g-4 align-items-center">
        ...
        <div class="col-md-6 col-sm-12 d-flex justify-content-md-end justify-content-center">
          <button wire:click="deleteSelected"
            class="btn btn-gradient-danger rounded-xl px-4 py-3 d-flex align-items-center gap-2 shadow-sm" @if (empty($selectedTemplates)) disabled @endif>
