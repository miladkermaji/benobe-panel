<div>
    <div class="container-fluid py-3" wire:init="loadEntries">
        <!-- Header -->
        <header class="bg-gradient-header text-white p-3 rounded-3 mb-3 d-flex align-items-center justify-content-between shadow-lg">
            <div class="d-flex align-items-center gap-3">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="header-icon">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="search-box position-relative">
                    <input type="text" wire:model.live="search" class="form-control rounded-pill ps-5 pe-3" placeholder="جستجو در ورودی‌ها...">
                </div>
        ...
        <div class="gateway-list d-flex flex-wrap gap-4 justify-content-center">
            @if ($readyToLoad)
                @forelse($entries as $entry)
                    <div class="gateway-card card border-0 rounded-3 shadow-lg position-relative overflow-hidden animate__animated animate__zoomIn">
                        ...
                        <div class="card-body p-4 d-flex flex-column gap-3 position-relative">
                            <div class="d-flex align-items-center gap-4">
                                <div class="gateway-logo rounded-circle bg-white shadow-lg d-flex align-items-center justify-content-center" style="width: 50px; height: 50px; border: 3px solid #ffffff;">
                                    @switch($entry->type)
                                        @case('request')
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-2">
                                ...
                                <button class="btn btn-custom rounded-pill px-3 py-1" wire:click="$dispatch('showDetails', '{{ $entry->uuid }}')">
                                    جزئیات
                                </button>
                            </div>
                        </div>
