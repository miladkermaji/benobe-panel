                                ...
                                @forelse ($redirects as $index => $redirect)
                                    <tr>
                                        <td class="text-center align-middle">
                                            <input type="checkbox" wire:model.live="selectedRedirects"
                                                value="{{ $redirect->id }}" class="form-check-input m-0">
                                        </td>
            ...
            Livewire.on('confirm-delete', (event) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch('deleteRedirectConfirmed', { id: event.id });
                    }
                });
            });
        });
