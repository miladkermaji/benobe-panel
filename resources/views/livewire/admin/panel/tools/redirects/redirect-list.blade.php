<div class="redirects-container">
  <div class="container py-2 mt-3" dir="rtl" wire:init="loadRedirects" x-data="{ mobileSearchOpen: false }">
    <div class="glass-header text-white p-2  shadow-lg">
      <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 w-100">
        ...
        <div class="d-flex align-items-center gap-2 flex-shrink-0">
          <h1 class="m-0 h4 font-thin text-nowrap mb-md-0">مدیریت ریدایرکت‌ها</h1>
