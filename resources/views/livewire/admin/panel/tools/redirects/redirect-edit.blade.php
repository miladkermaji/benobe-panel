            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="bg-light rounded-3 p-3 shadow-sm">
                        ...
                        <input type="text" wire:model="source_url" class="form-control" id="source_url"
                ...
                <div class="col-md-6">
                    <div class="bg-light rounded-3 p-3 shadow-sm">
                        ...
                        <input type="text" wire:model="target_url" class="form-control" id="target_url"
                ...
                <div class="col-md-6">
                    <div class="bg-light rounded-3 p-3 shadow-sm">
                        ...
                        <select wire:model="status_code" class="form-select" id="status_code">
