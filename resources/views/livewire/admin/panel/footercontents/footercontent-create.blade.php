    ...
    <div class="card shadow-lg border-0 rounded-3 overflow-hidden">
        <div class="card-header bg-gradient-primary text-white p-3 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <h5 class="mb-0 fw-bold">افزودن آیتم جدید فوتر</h5>
            </div>
            <a href="{{ route('admin.panel.footercontents.index') }}"
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="row g-4">
                        <div class="col-12 position-relative mt-5">
                            <input type="text" wire:model="section" class="form-control input-shiny" id="section" placeholder=" ">
                        ...
                        <div class="col-6 position-relative mt-5">
                            <input type="text" wire:model="link_url" class="form-control input-shiny" id="link_url" placeholder=" ">
                            <label for="link_url" class="form-label">لینک (اختیاری)</label>
                        </div>
                        <div class="col-6 position-relative mt-5">
                            <input type="text" wire:model="link_text" class="form-control input-shiny" id="link_text" placeholder=" ">
                        ...
                        <div class="col-6 position-relative mt-5">
                            <input type="number" wire:model="order" class="form-control input-shiny" id="order" min="0" placeholder=" ">
