<div class="container-fluid py-2" dir="rtl" wire:init="loadDoctorComments">
    <div class="glass-header text-white p-3 rounded-3 mb-5 shadow-lg d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-2 flex-shrink-0 flex-wrap justify-content-center mt-md-2 buttons-container">
            <a href="{{ route('admin.panel.doctorcomments.create') }}"
                                ...
                                <div class="table-responsive text-nowrap p-3 bg-light">
                                        ...
                                        <thead class="glass-header text-white">
                                            <tr>
                                                <th class="text-center align-middle" style="width: 50px;">
                                                    <input type="checkbox" wire:model.live="selectAll.{{ $doctor->id }}" class="form-check-input m-0">
                                                </th>
                                                ...
                                                <tr>
                                                    <td class="text-center align-middle">
                                                        <input type="checkbox" wire:model.live="selectedDoctorComments"
                                                            value="{{ $comment->id }}" class="form-check-input m-0">
                                                    </td>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        <div class="d-flex justify-content-center gap-2">
                                                            <a href="{{ route('admin.panel.doctorcomments.edit', $comment->id) }}"
                                    ...
                                    @if ($doctor->comments->hasPages())
                                        <div class="p-3 d-flex justify-content-between align-items-center flex-wrap gap-3">
                                            <span class="text-muted">نمایش {{ $doctor->comments->firstItem() }} تا {{ $doctor->comments->lastItem() }} از {{ $doctor->comments->total() }} نظر</span>
