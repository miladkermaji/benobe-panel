<div class="container-fluid py-4" dir="rtl">
    <div class="card shadow-lg border-0 rounded-3 overflow-hidden" style="background: #ffffff;">
        <div class="card-header bg-gradient-primary text-white p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <a href="{{ route('admin.panel.doctorcomments.index') }}" class="btn btn-outline-light btn-sm rounded-pill px-4 d-flex align-items-center gap-2 hover:shadow-lg transition-all">
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-md-6 position-relative mt-5">
                            ...
                            @error('user_phone') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
    ...
    <style>
        ...
        .btn-primary { background: linear-gradient(90deg, #6b7280, #374151); border: none; }
