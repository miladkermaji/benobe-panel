...
<div class="doctor-notes-container">
  <div class="container py-2 mt-3" dir="rtl" wire:init="loadImagingCenters">
    <div class="glass-header text-white p-2  shadow-lg">
      <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 w-100">
        <div class="d-flex flex-column flex-md-row gap-2 w-100 align-items-center justify-content-between">
          <div class="d-flex align-items-center gap-3">
            <h1 class="m-0 h4 font-thin text-nowrap mb-3 mb-md-0">مدیریت مراکز تصویربرداری</h1>
          </div>
            ...
            <div class="d-flex gap-2 flex-shrink-0 justify-content-center w-100 flex-column flex-md-row">
              <div class="search-container position-relative flex-grow-1 mb-2 mb-md-0 w-100">
                <input type="text"
                  ...
                  wire:model.live="search" placeholder="جستجو بر اساس نام مرکز، پزشک، شهر..."
      ...
      <div class="card shadow-sm rounded-2">
        <div class="card-body p-0">
          ...
          <div class="group-actions p-2 border-bottom" x-data="{ show: false }"
            x-show="$wire.selectedImagingCenters.length > 0 || $wire.applyToAllFiltered">
            ...
            <table class="table table-hover w-100 m-0">
              <thead>
                <tr>
                  ...
                  <th class="align-middle">نام مرکز</th>
