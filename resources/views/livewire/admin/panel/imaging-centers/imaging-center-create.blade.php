  ...
  <div class="card shadow-lg border-0 rounded-3 overflow-hidden" style="background: #ffffff;">
    <div
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <h5 class="mb-0 fw-bold text-shadow">افزودن مراکز تصویربرداری جدید</h5>
      </div>
        ...
        <div class="col-12 col-md-10 col-lg-8">
          <div class="row g-4">
            ...
            <div class="col-6 col-md-6 position-relative mt-5">
              ...
              <label for="name" class="form-label">نام مراکز تصویربرداری </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5">
              <input type="text" wire:model="title" class="form-control" id="title" placeholder=" ">
              <label for="title" class="form-label">عنوان مراکز تصویربرداری </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5" wire:ignore>
              ...
              <label for="specialty_ids" class="form-label">تخصص‌های مراکز تصویربرداری </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5" wire:ignore>
              ...
              <label for="insurance_ids" class="form-label">بیمه‌های مراکز تصویربرداری </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5" wire:ignore>
            ...
            <div class="col-6 col-md-6 position-relative mt-5 d-flex align-items-center">
              <div class="form-check form-switch w-100 d-flex align-items-center">
                ...
                <label class="form-check-label fw-medium" for="is_main_center">مراکز تصویربرداری اصلی</label>
              </div>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5 d-flex align-items-center">
              <div class="form-check form-switch w-100 d-flex align-items-center">
