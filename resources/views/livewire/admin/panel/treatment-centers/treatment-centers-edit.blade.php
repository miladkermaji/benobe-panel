        ...
        <div class="col-12 col-md-10 col-lg-8">
          <div class="row g-4">
            ...
            <div class="col-6 col-md-6 position-relative mt-5">
              ...
              <label for="title" class="form-label">عنوان درمانگاه </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5" wire:ignore>
              ...
              <label for="specialty_ids" class="form-label">تخصص‌های درمانگاه </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5" wire:ignore>
              ...
              <label for="insurance_ids" class="form-label">بیمه‌های درمانگاه </label>
            </div>
            <div class="col-6 col-md-6 position-relative mt-5" wire:ignore>
            ...
            <div class="col-12 position-relative mt-5">
              ...
              @if ($treatmentCenter->avatar)
                <img src="{{ Storage::url($treatmentCenter->avatar) }}" alt="تصویر اصلی" class="mt-2"
