            ...
            <div class="d-flex gap-2 flex-shrink-0 justify-content-center">
              <div class="search-container position-relative" style="max-width: 100%;">
                <input type="text"
                  ...
                  wire:model.live="search" placeholder="جستجو در درمانگاه  ها..."
                    ...
                    <tr>
                      <td colspan="15" class="text-center py-4">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                          ...
                          <p class="text-muted fw-medium">هیچ درمانگاه ی یافت نشد.</p>
                        </div>
                      </td>
                    </tr>
                  @endforelse
                ...
                <div class="clinic-card mb-3 p-3 border rounded-2 shadow-sm" x-data="{ open: false, showDoctors: false, showSpecialties: false, showInsurances: false, showServices: false }">
                  ...
                  <div class="clinic-card-body mt-2" x-show="open" x-transition>
                    <div class="clinic-card-item">
                      ...
                      <span class="clinic-card-value">{{ $treatmentCenters->firstItem() + $index }}</span>
                    </div>
                    <div class="clinic-card-item">
