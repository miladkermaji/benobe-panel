...
<div class="doctor-notes-container" x-data="{ mobileSearchOpen: false }">
  <div class="container py-2 mt-3" dir="rtl" wire:init="loadTreatmentCenters">
    <!-- Header -->
          ...
          <div class="d-flex flex-column gap-2">
            <div class="search-box position-relative">
              <input type="text" wire:model.live="search" class="form-control ps-5"
                placeholder="جستجو بر اساس نام درمانگاه، پزشک، شهر...">
            ...
            <div class="d-flex align-items-center gap-2 justify-content-between">
              ...
              <span class="badge bg-white text-primary px-2 py-1 fw-medium flex-shrink-0">
                {{ $readyToLoad ? $treatmentCenters->total() : 0 }}
              </span>
            </div>
          </div>
        </div>
      ...
      <div class="card shadow-sm rounded-2">
        <div class="card-body p-0">
          ...
          <div class="group-actions p-2 border-bottom" x-data="{ show: false }"
            x-show="$wire.selectedTreatmentCenters.length > 0 || $wire.applyToAllFiltered">
            ...
            <table class="table table-hover w-100 m-0">
              <thead>
                <tr>
                  ...
                  <th class="align-middle">نام درمانگاه</th>
                  ...
                  @forelse ($treatmentCenters as $index => $item)
                    <tr class="align-middle">
                      <td class="text-center">
                        <div class="d-flex justify-content-center align-items-center">
                          <input type="checkbox" wire:model.live="selectedTreatmentCenters"
          ...
          <div class="d-flex justify-content-between align-items-center mt-3 px-3 flex-wrap gap-2">
            @if ($readyToLoad)
              <div class="text-muted">
                نمایش {{ $treatmentCenters->firstItem() }} تا {{ $treatmentCenters->lastItem() }}
                از {{ $treatmentCenters->total() }} ردیف
              </div>
              @if ($treatmentCenters->hasPages())
