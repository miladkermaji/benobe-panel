  ...
  <div class="sidebar__scrollable">
    <ul class="" id="">
      @if (Auth::guard('manager')->check())
        <!-- داشبورد -->
        @if ($this->hasManagerPermission('dashboard'))
        ...
        @if ($this->hasManagerPermission('tools'))
          <li class="item-li i-tools">
            ...
            <ul class="drop-toggle d-none">
              ...
              <li class="item-li"><a href="{{ route('admin.panel.tools.payment_gateways.index') }}">درگاه پرداخت</a>
              </li>
              ...
              <li class="item-li"><a href="{{ route('admin.panel.tools.notifications.index') }}">مدیریت اعلان‌ها</a>
              </li>
            </ul>
          </li>
        @endif
        ...
        @if ($this->hasManagerPermission('doctor_management'))
          <li class="item-li i-doctor-management">
            ...
            <ul class="drop-toggle d-none">
              ...
              <li class="item-li"><a href="{{ route('admin.panel.doctor-specialties.index') }}">تخصص های پزشک</a>
              </li>
        ...
        @if ($this->hasManagerPermission('medical_centers'))
          <li
            ...
            <ul class="drop-toggle d-none">
              ...
              <li
                class="item-li {{ Request::routeIs('admin.panel.medical-centers.permissions') ? 'is-active' : '' }}">
        ...
        <!-- مدیریت استوری‌ها -->
        @if ($this->hasManagerPermission('stories'))
          <li class="item-li i-stories {{ Request::routeIs('admin.panel.stories.*') ? 'is-active' : '' }}">
            <a href="#" class="d-flex justify-content-between w-100 align-items-center">
              مدیریت استوری‌ها
              <div class="d-flex justify-content-end w-100 align-items-center">
                <svg width="6" height="9" class="svg-caret-left" viewBox="0 0 7 11" fill="none"
            ...
            <ul class="drop-toggle d-none">
              <li class="item-li {{ Request::routeIs('admin.panel.stories.index') ? 'is-active' : '' }}">
                <a href="{{ route('admin.panel.stories.index') }}">لیست استوری‌ها</a>
              </li>
              <li class="item-li {{ Request::routeIs('admin.panel.stories.create') ? 'is-active' : '' }}">
                <a href="{{ route('admin.panel.stories.create') }}">ایجاد استوری جدید</a>
              </li>
              <li class="item-li {{ Request::routeIs('admin.panel.stories.analytics') ? 'is-active' : '' }}">
                <a href="{{ route('admin.panel.stories.analytics') }}">آمار و تحلیل</a>
              </li>
            </ul>
          </li>
        @endif
