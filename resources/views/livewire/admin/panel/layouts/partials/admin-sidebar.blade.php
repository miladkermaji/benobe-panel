        ...
        @if (Auth::guard('manager')->check())
            ...
            <li class="item-li i-courses">
                ...
                <ul class="drop-toggle d-none">
                    ...
                    <li
                        class="item-li {{ Request::routeIs('admin.panel.tools.payment_gateways.index') ? 'is-active' : '' }}">
            ...
            <li class="item-li i-users">
                ...
                <ul class="drop-toggle d-none">
                    ...
                    <li class="item-li">
                        <a href="#">افزودن پزشک</a>
                    </li>
                    <li class="item-li">
                        <a href="#">تأیید مدارک</a>
                    </li>
                    <li class="item-li">
                        <a href="#">مدیریت نوبت‌دهی</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="item-li i-courses">
                ...
                <ul class="drop-toggle d-none">
                    <li class="item-li">
                        <a href="#">نوبت‌های فعال</a>
                    </li>
                    <li class="item-li">
                        <a href="#">نوبت‌های لغو شده</a>
                    </li>
                    <li class="item-li">
                        <a href="#">تنظیمات نوبت‌دهی</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="item-li i-courses">
                ...
                <ul class="drop-toggle d-none">
                    <li class="item-li">
                        <a href="#">تنظیمات عمومی</a>
                    </li>
                    <li class="item-li">
                        <a href="#">مدیریت صفحات</a>
                    </li>
                    <li class="item-li">
                        <a href="#">تنظیمات SEO</a>
                    </li>
                </ul>
            </li>
