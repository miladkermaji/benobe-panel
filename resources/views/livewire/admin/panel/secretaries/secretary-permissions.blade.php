<div class="container-fluid py-4" dir="rtl">
  <div class="glass-header p-4  mb-6 shadow-lg d-flex justify-content-between align-items-center flex-wrap gap-4">
    <h1 class="m-0 h3 font-light flex-grow-1" style="min-width: 200px; color: var(--text-primary);">دسترسی‌های منشی‌ها
    </h1>
              ...
              <tr x-show="open" x-transition>
                <td class="align-middle" colspan="2">
                  @forelse ($doctor->secretaries as $secretary)
                    <div class="mb-3 p-2 rounded-3 shadow-sm" x-data="{ open: true }"
                      ...
                      <div class="fw-bold text-primary mb-2 d-flex align-items-center justify-content-between"
                        style="font-size: 1.08rem; cursor:pointer;">
                        <span>
                          <svg width="18" height="18" fill="none" stroke="#0d6efd" stroke-width="2"
                            style="vertical-align: middle; margin-left: 6px;">
                            <circle cx="9" cy="9" r="8" />
                            ...
                            <div class="d-flex align-items-center mb-2">
                              <label class="custom-checkbox flex items-center gap-2">
                                <input type="checkbox" class="custom-checkbox-input parent-checkbox form-check-input"
                                  data-secretary-id="{{ $secretary->id }}" data-permission-key="{{ $permissionKey }}"
                  ...
                  @empty
                    <div class="p-4 text-text-secondary text-center font-medium">منشی‌ای برای این دکتر ثبت نشده است.
                    </div>
                  @endforelse
                </td>
              </tr>
