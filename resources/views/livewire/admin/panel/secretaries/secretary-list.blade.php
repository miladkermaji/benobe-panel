                      ...
                      <div class="doctor-toggle border-bottom transition-all duration-300 hover:bg-background-light">
                          <div class="d-flex justify-content-between align-items-center p-4 cursor-pointer"
                              ...
                              <div class="d-flex align-items-center gap-3">
                                  ...
                                  <span class="fw-bold text-text-primary text-lg">{{ $doctor->first_name . ' ' . $doctor->last_name }} ({{ $doctor->mobile }})</span>
                                  <span class="badge-comment bg-gradient-primary text-white font-medium px-3 py-1 rounded-full shadow-sm hover:shadow-md transition-all duration-300">{{ $doctor->secretaries->count() }} منشی</span>
                              </div>
                                      ...
                                      <tbody>
                                          @forelse ($doctor->secretaries as $index => $secretary)
                                              <tr class="hover:bg-background-light transition-colors duration-200">
                                                  ...
                                                  <td class="align-middle text-text-primary">{{ $secretary->first_name . ' ' . $secretary->last_name }}</td>
                                                  <td class="align-middle text-text-secondary">{{ $secretary->mobile }}</td>
                                                  <td class="align-middle text-text-primary">{{ $secretary->clinic ? $secretary->clinic->name : '-' }}</td>
                                      ...
                                      @forelse ($doctor->secretaries as $index => $secretary)
                                          <div class="card mb-3 rounded-xl shadow-md bg-background-card">
                                              <div class="card-body p-3">
                                                  ...
                                                  <div class="mb-2">
                                                      <p class="text-text-primary mb-1 text-sm"><strong>نام منشی:</strong> {{ $secretary->first_name . ' ' . $secretary->last_name }}</p>
                                                      <p class="text-text-secondary mb-1 text-sm"><strong>موبایل:</strong> {{ $secretary->mobile }}</p>
                                                      <p class="text-text-primary mb-1 text-sm"><strong>کلینیک:</strong> {{ $secretary->clinic ? $secretary->clinic->name : '-' }}</p>
                                                  </div>
