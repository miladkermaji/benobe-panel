  ...
  <section class="login-dr-content  d-flex justify-content-center align-items-center">
    <section class="login-wrapper">
      ...
      <form action="{{ route('secretary-two-factor-store') }}" method="POST">
        ...
        <section class="login-btn d-grid g-2"><button class="btn btn-secondary  btn-lg" type="submit"
            id="btn-login-dr-otp">
            تایید
            <span class="loading-svg-container d-none">
              <svg x="0px" y="0px" viewBox="0 0 50 31.25" height="31.25" width="50"
      ...
      <section class="login-btn d-grid g-2 mt-2">
        <button class="btn btn-outline-danger btn-lg"
          onclick="location.href='{{ route('dr.auth.login-register-form') }}'">
