...
<head>
    ...
    <title>تلسکوپ{{ config('app.name') ? ' - ' . config('app.name') : '' }}</title>
    <link rel="stylesheet" href="{{ asset('admin-assets/css/teleskope/telescope-rtl.css') }}">
    <!-- استایل‌ها -->
...
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            ...
            <!-- دکمه برگر -->
            <button class="btn btn-muted burger-menu d-flex align-items-center py-2 ml-3 d-lg-none" id="burgerBtn" title="باز کردن منو">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M3 6h18v2H3V6zm0 5h18v2H3v-2zm0 5h18v2H3v-2z"/>
                </svg>
            </button>

            <button class="btn btn-muted mr-auto ml-3 d-flex align-items-center py-2" v-on:click.prevent="toggleRecording" :title="recording ? 'مکث ضبط' : 'ادامه ضبط'">
            ...
            <button class="btn btn-muted ml-3 d-flex align-items-center py-2" v-on:click.prevent="clearEntries" title="پاک کردن ورودی‌ها">
            ...
            <button class="btn btn-muted ml-3 d-flex align-items-center py-2" :class="{active: autoLoadsNewEntries}" v-on:click.prevent="autoLoadNewEntries" title="بارگذاری خودکار ورودی‌ها">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
                    <path fill-rule="evenodd" d="M15.312 11.424a5.5 5.5 0 01-9.201 2.466l-.312-.311h2.433a.75.75 0 000-1.5H3.989a.75.75 0 00-.75.75v4.242a.75.75 0 001.5 0v-2.43l.31.31a7 7 0 0011.712-3.138.75.75 0 00-1.449-.39zm1.23-3.723a.75.75 0 00.219-.53V2.929a.75.75 0 00-1.5 0V5.36l-.31-.31A7 7 0 003.239 8.188a.75.75 0 101.448.389A5.5 5.5 0 0113.89 6.11l.311.31h-2.432a.75.75 0 000 1.5h4.243a.75.75 0 00.53-.219z" clip-rule="evenodd" />
                </svg>
            </button>

            <router-link to="/monitored-tags" class="btn btn-muted d-flex align-items-center py-2" title="نظارت">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
        ...
        <div class="row mt-4">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/client-requests" class="nav-link d-flex align-items-center">
                            ...
                            <span>درخواست‌های کلاینت HTTP</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/notifications" class="nav-link d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M4.214 3.227a.75.75 0 00-1.156-.956 8.97 8.97 0 00-1.856 3.826a.75.75 0 001.466.316 7.47 7.47 0 011.546-3.186zM16.942 2.271a.75.75 0 00-1.157.956 7.47 7.47 0 011.547 3.186.75.75 0 001.466-.316 8.971 8.971 0 00-1.856-3.826z" />
            ...
            <div class="col-10 main-content" id="mainContent">
