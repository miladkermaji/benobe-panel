...
<div class="blogs-content container py-5">
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            ...
            <div class="d-flex gap-3">
              <a href="{{ $post['read_more_link'] }}" class="btn my-btn-primary" target="_blank">بیشتر بخوانید</a>
        ...
        <ul class="pagination justify-content-center">
          ...
          @for ($i = 1; $i <= $total_pages; $i++)
            <li class="page-item {{ $current_page == $i ? 'active' : '' }}">
              <a class="page-link"
                href="{{ route('admin.panel.blogs.index', ['page' => $i]) }}">{{ $i }}</a>
            </li>
          @endfor
  ...
  <div class="mt-4 text-center">
    <a href="{{ route('admin.panel.blogs.index', ['page' => $current_page, 'refresh' => 1]) }}"
      class="btn btn-warning">به‌روزرسانی پست‌ها</a>
  </div>
</div>
@endsection
