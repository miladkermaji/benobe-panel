...
@section('styles')
  ...
  <link type="text/css" href="{{ asset('mc-assets/panel/css/turn/schedule/scheduleSetting/workhours.css') }}"
    rel="stylesheet" />
  <link type="text/css" href="{{ asset('mc-assets/panel/css/turn/schedule/appointments_open/appointments_open.css') }}"
    rel="stylesheet" />
@endsection
@section('site-header')
  {{ 'به نوبه | پنل دکتر' }}
        ...
        <form method="post" action="" id="savebarname">
          ...
          <div class="card-barname active" id="BarnameOne">
            <label for="barname_one" class="radio">
              <input type="radio" class="form-check-input" id="barname_one" name="barname_setting" value="1"
                checked="">
            </label>
            <div class="body">
              ...
              <div class="data d-flex gap-4 align-items-center mt-3">
                <div class="form-group-barname position-relative">
                  ...
                  <input class="form-control h-50 " type="time" name="barname[1][start_time]" value="00:00"
                    class="input-barname">
                </div>
                <div class="form-group-barname position-relative">
                  <label class="label-top-input-special-takhasos">ساعت پایان</label>
                  <input class="form-control h-50" type="time" name="barname[1][end_time]" value="23:59"
                    class="input-barname">
                </div>
              </div>
            </div>
          ...
          <div class="card-barname" id="BarnameTwo">
            ...
            <div class="body">
              ...
              <div class="data mt-3">
                <div class="form-group-barname position-relative">
                  <label class="label-top-input-special-takhasos">ساعت پایان</label>
                  <input class="form-control h-50" type="time" name="barname[2][end_time]" value="12:00"
                    class="input-barname">
                </div>
              </div>
            </div>
              ...
              <div class="data">
                <div class="form-group">
                  ...
                  <div class="mt-2 d-flex flex-wrap gap-10 justify-content-center my-768px-styles-day-and-times">
                    <div class="" tabindex="0" role="button"><span
                        class="badge-time-styles-day">شنبه</span><span class=""></span>
                    </div>
                    <div class="" tabindex="0" role="button"><span
                        class="badge-time-styles-day">یکشنبه</span><span class=""></span>
                    </div>
                    <div class="" tabindex="0" role="button"><span
                        class="badge-time-styles-day">دوشنبه</span><span class=""></span>
                    </div>
                    <div class="" tabindex="0" role="button"><span
                        class="badge-time-styles-day">سه‌شنبه</span><span class=""></span>
                    </div>
                    <div class="" tabindex="0" role="button"><span
                        class="badge-time-styles-day">چهارشنبه</span><span class=""></span></div>
                    <div class="" tabindex="0" role="button"><span
                        class="badge-time-styles-day">پنج‌شنبه</span><span class=""></span></div>
                    <div class="" tabindex="0" role="button"><span
                        class="badge-time-styles-day">جمعه</span><span class=""></span></div>
                  </div>
                </div>
                <div class="data d-flex gap-4 align-items-center mt-3">
                  <div class="form-group-barname position-relative">
