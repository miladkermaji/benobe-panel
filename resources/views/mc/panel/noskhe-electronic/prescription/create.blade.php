...
@section('styles')
  ...
  <link type="text/css" href="{{ asset('mc-assets/panel/css/noskhe-electronic/providers/providers.css') }}"
    rel="stylesheet" />
  <link type="text/css" href="{{ asset('mc-assets/panel/css/noskhe-electronic/favorite/templates/index.css') }}"
    rel="stylesheet" />
  <link type="text/css" href="{{ asset('mc-assets/panel/css/noskhe-electronic/favorite/templates/create.css') }}"
    rel="stylesheet" />
@endsection
@section('site-header')
  {{ 'به نوبه | پنل دکتر' }}
  ...
  <div class="patient-profile-details p-3 border">
    <div id="patient-profile-details-wrapper" class="d-flex justify-content-between align-items-center">
          ...
          <span class="fw-bold">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path
                ...
                stroke="#2b2f33" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
      ...
      <div class="d-flex gap-10 align-items-center">
        <div>
          <svg class="cursor-pointer" data-bs-toggle="modal" data-bs-target="#addToFavModalCenter" width="24"
      ...
      <div class="content-current-chooser w-100  position-relative">
        <div class="w-100">
          <form action="" method="post" class="w-100">
            ...
            <div class="d-flex  position-relative mt-4 w-100 flex-wrap justify-content-around gap-4">
      ...
      <div class="lists-of mt-4 w-100">
        <div class="table-responsive">
                ...
                <th>
                  <button class="btn btn-light">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                      xmlns="http://www.w3.org/2000/svg" data-tip="true" data-for="deleteAll" currentItem="false">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        fill="#EB5757"></path>
                      <path d="M10.1934 11.4708L13.8061 15.0836" stroke="#EB5757" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round"></path>
                      <path d="M13.8066 11.4708L10.1939 15.0836" stroke="#EB5757" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                  </button>
                </th>
          ...
          <div style="display: flex; gap: 1rem; justify-content: center; align-items: center;"><img
              ...
              alt="" style="width: 3rem;"><span style="font-weight: 500; opacity: 0.7;"
              class="text-nothing">خدمتی
      ...
      <div class="content-current-chooser w-100  position-relative">
        <div class="w-100">
          <form action="" method="post" class="w-100">
            ...
            <div class="d-flex  position-relative mt-4 w-100 flex-wrap justify-content-start gap-4">
              <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12 mt-xs-3">
                <label for="" class="label-top-input-content-noskhe">تعداد </label>
                <input type="number" class="form-control h-50 position-relative" min="0">
              </div>
...
<script src="{{ asset('mc-assets/panel/js/noskhe-electronic/favorite/templates/index.js') }}"></script>
<script src="{{ asset('mc-assets/panel/js/noskhe-electronic/favorite/templates/create.js') }}"></script>
<script>
