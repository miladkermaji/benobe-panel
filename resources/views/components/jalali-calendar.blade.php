  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function generateCalendar(year, month) {
        ...
        // برای دیباگ ترتیب روزهای هفته
        console.log(`First day of ${year}/${month}: weekday ${firstDayWeekday}`);
        ...
        for (let day = 1; day <= daysInMonth; day++) {
          ...
          // بررسی روز جمعه
          if (currentDay.day() === 5) { // تغییر به 5 چون تقویم جلالی از شنبه (0) شروع می‌شه و جمعه 5ه
