<div class="days-calendar-cards mt-4" id="days-calendar-cards">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    Object.keys(daysMap).forEach(function(day) {
      ...
      var dayContent = `
            <h6 class="text-center fw-bold">${day} ها</h6>
            ...
            var appointmentsPattern = `
                        <div class="appointment-pattern-${pattern.id} d-details" data-toggle="tooltip" title="برای مشاهده سایر نوبت‌ها کلیک کنید">
                            <div class="d-flex flex-column align-items-center justify-content-center overflow-y-scroll" style="max-height: 200px;">
                                <div><span class="fw-bold">${startTime} الی ${endTime}</span></div>
                                <div><span class="fw-bold">${pattern.max_appointments} نفر</span></div>
                            </div>
                        </div>`;
...
<!-- Modal -->
<div class="modal fade" id="currentDayModal" tabindex="-1" role="dialog" aria-labelledby="currentDayModallLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="table-responsive ">
          ...
          <div id="no-pattern-message">
            <div class="ant-empty d-flex justify-content-center w-100 flex-column align-items-center">
              <div class="ant-empty-image"><svg width="184" height="152" viewBox="0 0 184 152"
        ...
        <form id="appointment-form">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" placeholder="عنوان برنامه">
          </div>
          <div class="d-flex flex-wrap w-100">
            <div class="form-group col-6 col-sm-12 col-md-6">
              <label for="start-time">زمان شروع</label>
              <select class="form-control select2" id="start-time" style="width: 100%">
            ...
            <div class="form-group col-6 col-sm-12 col-md-6">
              ...
              <select class="form-control select2" id="end-time" style="width: 100%">
          ...
          <div class="form-group">
            ...
            <div class="d-flex align-items-center">
              <input type="number" class="form-control text-center mx-2" id="max_appointments" name="max_appointments"
                value="10" min="1">
            </div>
          </div>
          <div class="mt-2 p-2" id="holiday_container">
            <h6 class=" d-flex justify-content-center align-items-center  py-2 rounded-30">آیا تعطیلات رسمی برای برنامه
              ...
              <div class="ant-click-animating-node mx-2">
                <label class="switch mt-3">
                  <input type="checkbox" checked="" id="holiday-schedule_pattern">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-dark rounded-circle" id="save-pattern">
          <svg viewBox="64 64 896 896" focusable="false" class="" data-icon="plus" width="14"
