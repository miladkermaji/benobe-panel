...
<script>
  ...
  window.openXModal = function(modalId) {
    ...
    if (modal) {
      ...
      // Dispatch custom event for modal show
      modal.dispatchEvent(new CustomEvent('x-modal:show'));
    }
  };
  ...
  window.closeXModal = function(modalId) {
    ...
    if (modal) {
      modal.classList.remove('x-modal--visible');
      // Dispatch custom event for modal hide
      modal.dispatchEvent(new CustomEvent('x-modal:hide'));
    }
  };
</script>
