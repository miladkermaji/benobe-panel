...
@section('content')
  ...
  <div class="container subuser-content w-100 d-flex justify-content-center mt-4">
    <div class="subuser-content-wrapper  w-100">
      ...
      <!-- کارت‌های منشی برای موبایل/تبلت -->
      <div class="notes-cards d-md-none">
        @forelse ($secretaries as $index => $secretary)
          <div class="note-card mb-3" data-id="{{ $secretary->id }}">
            <div class="note-card-header d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center gap-2">
                <input type="checkbox" class="form-check-input m-0 align-middle select-secretary"
                  value="{{ $secretary->id }}">
                <span
                  class="badge bg-primary-subtle text-primary">{{ $secretary->gender === 'male' ? 'مرد' : 'زن' }}</span>
              </div>
              <div class="d-flex gap-1">
                <button class="btn btn-sm btn-gradient-success px-2 py-1 edit-btn" data-id="{{ $secretary->id }}"
                  title="ویرایش">
                ...
                <button class="btn btn-sm btn-gradient-danger px-2 py-1 delete-btn" data-id="{{ $secretary->id }}"
                  title="حذف">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    stroke-width="2">
            ...
            <div class="note-card-body">
              <div class="note-card-item">
                ...
                <span class="note-card-value">{{ $secretary->first_name }} {{ $secretary->last_name }}</span>
              </div>
              <div class="note-card-item">
                <span class="note-card-label">شماره موبایل:</span>
                <span class="note-card-value">{{ $secretary->mobile }}</span>
              </div>
              <div class="note-card-item">
                <span class="note-card-label">کدملی:</span>
                <span class="note-card-value">{{ $secretary->national_code }}</span>
              </div>
              <div class="note-card-item">
        ...
        @empty
          <div class="text-center py-4">
            <div class="d-flex justify-content-center align-items-center flex-column">
              ...
              <p class="text-muted fw-medium">شما منشی فعالی ندارید</p>
            </div>
          </div>
        @endforelse
      </div>
