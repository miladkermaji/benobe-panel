  ...
  <div class="d-flex  justify-content-center  gap-20 top-s-a-wrapper">
    <div class="rounded-lg d-flex justify-content-center align-items-center p-3 bg-light-blue">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          fill="#000"></path>
      </svg><span class="fw-bold mr-2 ml-2 text-dark">تعداد بیماران امروز</span><span
    ...
    <div class="rounded-lg d-flex justify-content-center align-items-center p-3 bg-light-blue"><svg width="25"
        ...
        <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          fill="#000"></path>
      </svg><span class="fw-bold mr-2 ml-2 text-dark">بیماران ویزیت شده</span><span
    ...
    <div class="rounded-lg d-flex justify-content-center align-items-center p-3 bg-light-blue"><svg width="24"
        ...
        <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          fill="#000"></path>
      </svg><span class="fw-bold mr-2 ml-2 text-dark">بیماران باقی مانده</span><span
      ...
      <table class="table w-100 text-sm text-center">
        <thead class="text-xs text-gray-700 uppercase border-b border-solid bg-gray-50 border-b-gray-100">
          <tr>
            ...
            <th scope="col" class="px-6 py-3">وضعیت مشاوره</th>
            <th scope="col" class="px-6 py-3">وضعیت پرداخت</th>
            <th scope="col" class="px-6 py-3"> نوع مشاوره</th>
            <th scope="col" class="px-6 py-3">تاریخ مشاوره</th>
            <th scope="col" class="px-6 py-3">زمان مشاوره</th>
    ...
    <div class="d-flex align-items-center m-2 gap-4">
      ...
      <button id="cancel-appointments-btn"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"
          height="20" width="20" version="1.1" id="Capa_1" viewBox="0 0 58 58" xml:space="preserve">
          <g>
            <path
        ...
        <span class="d-none d-md-block mx-1">لغو مشاوره</span>
      </button>
      <button id="move-appointments-btn"
        ...
        <span class="d-none d-md-block mx-1">جابجایی مشاوره</span>
      </button>
      ...
      <div class="modal-body my-modal-body">
        <div class="d-flex flex-column align-items-center w-100">
          <ul class="mx-4text-sm font-medium list-disc d-flex flex-column">
            ...
            <li>بیمار در قبض مشاوره و در نوبت‌های من، دکمه برقراری تماس را دارد.</li>
            <li>بیمار تنها در ساعت کاری پزشک، قادر به تماس با پزشک است.</li>
            <li>بیمار از زمان مشاوره تا ۳ روز بعد از زمان نوبت، دکمه تماس را در اختیار دارد.</li>
...
<div class="modal  fade" id="rescheduleModal" tabindex="-1" aria-labelledby="rescheduleModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content border-radius-6">
      ...
      <div class="modal-body">
        <p class="fw-bold">لطفا یک روز جدید را انتخاب کنید:</p>
