  ...
  <div class="max-width-800 mx-auto">
   <div class="row">
    <div class="col-12"><span class="d-flex align-items-center justify-content-start"><i aria-label="icon: picture"
       class="anticon anticon-picture ml-1 px-1"><svg viewBox="64 64 896 896" focusable="false" class=""
   ...
   <div class="row">
    <div class="col-12 w-100 d-flex justify-content-end">
     <div class="gallery_buttonsContainer__1mHVD gallery_contentCenter__36TQo d-flex justify-content-end mt-4"><button
       type="button" class="btn bg-nobat ml-2 btn-info ant-btn-lg h-50"><span>بارگذاری تصویر جدید</span></button>
     </div>
    </div>
   </div>
  </div>
