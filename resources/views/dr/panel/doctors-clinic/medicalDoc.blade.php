...
<div class="main-content">
  <div class="container-fluid bg-white p-2">
    <div class="max-width-800 mx-auto">
      <div class="col-12">
        <div class="row">
          <div class="col-12"><span class="d-flex align-items-center justify-content-start"><i
                aria-label="icon: picture" class="anticon anticon-picture ml-1"><svg viewBox="64 64 896 896"
                  focusable="false" class="" data-icon="picture" width="1em" height="1em" fill="currentColor"
                  aria-hidden="true">
                  <path
              ...
              <div class="row mt-3">
                ...
                <div class="text-right w-100 mt-2"><i aria-label="icon: delete" tabindex="-1"
                    class="anticon anticon-delete text-danger cursor-pointer font-20 btn btn-light rounded-circle"><svg
                      viewBox="64 64 896 896" focusable="false" class="" data-icon="delete" width="1em"
