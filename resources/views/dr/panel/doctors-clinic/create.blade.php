                        ...
                        <div class="col-12 col-md-10 col-lg-8">
                            <div class="row g-4">
                                <div class="col-md-6 col-sm-12 position-relative mt-5">
                                    <input type="text" name="name" class="form-control" id="clinic-name" placeholder="نام مطب" required>
                                ...
                                <div class="col-md-6 col-sm-12 position-relative mt-5">
                                    <input type="text" name="phone_numbers[]" class="form-control" id="clinic-phone" placeholder="شماره موبایل" required>
                                ...
                                <div class="col-md-6 col-sm-12 position-relative mt-5">
                                    <input type="text" name="postal_code" class="form-control" id="clinic-postal-code" placeholder="کد پستی">
                                ...
                                <div class="col-12 text-end mt-4">
                                    <button type="submit" class="btn my-btn-primary px-5 py-2 d-flex align-items-center gap-2" aria-label="ذخیره مطب">
