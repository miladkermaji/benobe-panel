      ...
      <div class="">
        <div class="!bg-white w-full min-h-100 d-flex flex-column align-items-center justify-between">
              ...
              <div class="d-flex flex-column gap-4">
                <div class="d-flex flex-column justify-content-center align-items-center">
                  <img
                    ...
                    alt="" class="mx-auto mt-4"><span
                    class="text-center text-dark w-100 font-weight-bold  p-3 leading-8">قوانین و
                    مقررات
                ...
                <div class="h-100 overflow-auto">
                  <div class="form-check d-flex align-items-start cursor-pointer mt-3">
                    ...
                    <label class="form-check-label text-justify font-weight-bold" for="checkbox1">ویزیت آنلاین در پیام
                      رسان اعلامی
                      شما و
                  ...
                  <div class="form-check d-flex align-items-start cursor-pointer mt-3">
                    ...
                    <label class="form-check-label text-justify font-weight-bold" for="checkbox2">ویزیت آنلاین می بایست از
                      راس زمان
                      نوبت
                  ...
                  <div class="form-check d-flex align-items-start cursor-pointer mt-3">
                    ...
                    <label class="form-check-label text-justify font-weight-bold" for="checkbox3">در زمان شروع ویزیت
                      بیمار، دکمه
                      پذیرش
                  ...
                  <div class="form-check d-flex align-items-start cursor-pointer mt-3">
                    ...
                    <label class="form-check-label text-justify font-weight-bold" for="checkbox4">توضيحات درمان و در صورت
                      نیاز ثبت
                      نسخه
                  ...
                  <div class="form-check d-flex align-items-start cursor-pointer mt-3">
                    ...
                    <label class="form-check-label text-justify font-weight-bold" for="checkbox5">هزینه هر ویزیت پس از
                      اعلام مراجعه
                      و
                  ...
                  <div class="form-check d-flex align-items-start cursor-pointer mt-3">
                    ...
                    <label class="form-check-label text-justify font-weight-bold" for="checkbox6">در صورت نارضایتی بیمار،
                      ۱۰۰ درصد
                      مبلغ
          ...
          <div class="d-flex w-100 py-4 px-6 justify-content-between position-relative bottom-0 mt-4">
            ...
            <button class="btn btn-outline-primary h-50 col-6" tabindex="0" type="button">انصراف<span
                class=""></span>
            </button>
            <script>
