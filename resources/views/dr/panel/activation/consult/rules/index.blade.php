       ...
       <div class="d-flex flex-column gap-4">
        ...
        <div class="h-100 overflow-auto">
         <div class="form-check d-flex align-items-start cursor-pointer mt-3">
          ...
          <label class="form-check-label text-justify font-weight-bold" for="checkbox1">ویزیت آنلاین در پیام رسان اعلامی
           شما و
           انتخابی بیمار انجام می شود.</label>
         </div>
         <div class="form-check d-flex align-items-start cursor-pointer mt-3">
          <input class="form-check-input" name="question_2" type="checkbox" id="checkbox2">
          <label class="form-check-label text-justify font-weight-bold" for="checkbox2">ویزیت آنلاین می بایست از راس زمان
           نوبت
         ...
         <div class="form-check d-flex align-items-start cursor-pointer mt-3">
          ...
          <label class="form-check-label text-justify font-weight-bold" for="checkbox3">در زمان شروع ویزیت بیمار، دکمه
           پذیرش
         ...
         <div class="form-check d-flex align-items-start cursor-pointer mt-3">
          ...
          <label class="form-check-label text-justify font-weight-bold" for="checkbox4">توضيحات درمان و در صورت نیاز ثبت
           نسخه
         ...
         <div class="form-check d-flex align-items-start cursor-pointer mt-3">
          ...
          <label class="form-check-label text-justify font-weight-bold" for="checkbox5">هزینه هر ویزیت پس از اعلام مراجعه
           و
         ...
         <div class="form-check d-flex align-items-start cursor-pointer mt-3">
          ...
          <label class="form-check-label text-justify font-weight-bold" for="checkbox6">در صورت نارضایتی بیمار، ۱۰۰ درصد
           مبلغ
