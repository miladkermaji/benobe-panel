    ...
    checkboxes.forEach(checkbox => {
      checkbox.addEventListener('change', () => {
        ...
        if (allChecked) {
          ...
          agreeButton.classList.add('btn-primary');
        } else {
          agreeButton.disabled = true;
          agreeButton.classList.remove('btn-primary');
          agreeButton.classList.add('btn-secondary');
        }
      });
    });
  </script>
