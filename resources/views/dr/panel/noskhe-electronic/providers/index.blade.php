...
<div class="container my-5">
  <div class="row justify-content-center">
    <div class="col-12">
      <div class="alert alert-info bg-light-blue p-4 rounded-3 shadow-sm">
        <p class="mb-2">برای احراز هویت نسخه نویسی، کافیست یکبار برای همیشه اطلاعات مربوط به احراز هویت بیمه سلامت و
          تامین اجتماعی خود را وارد کنید.</p>
        <p class="mb-2">- اطلاعات کاربری تامین اجتماعی برای مرکز درمانی و مطب شخصی یکسان می باشد و با ورود کد نظام، کد
          ملی و شماره موبایل ثبت شده در سامانه تامین اجتماعی، احراز هویت کنید.</p>
        <p class="mb-2">- نام کاربری و رمز عبور شما در مطب و هر مرکز درمانی برای بیمه سلامت متفاوت است که آن را می
          توانید از سازمان بیمه سلامت دریافت کنید.</p>
        <p class="mb-0">- ممکن است برای احراز هویت بیمه سلامت رمز عبور دو مرحله ای داشته باشید که هر 24 ساعت یکبار، می
          بایست موقع نسخه نویسی، کد 5 رقمی پیامک شده را وارد کنید.</p>
      </div>
    </div>
  </div>

  <div class="row justify-content-center g-4 mt-4">
    <!-- کارت بیمه تامین اجتماعی -->
    <div class="col-12 col-md-6 col-lg-5">
      <div class="provider-card card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white p-4 border-bottom-0">
          <div class="d-flex align-items-center gap-2">
            ...
            <h5 class="mb-0 font-weight-bold text-dark">بیمه تامین اجتماعی</h5>
          </div>
        </div>
        <div class="card-body p-4">
          <div class="d-flex align-items-center justify-content-between">
            <div>
              ...
              <span class="d-block mt-1 text-muted font-size-13">احراز هویت تامین اجتماعی</span>
            </div>
            <div>
              <span class="badge bg-success-subtle text-success rounded-pill px-3 py-2">احراز هویت شده</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- مودال ویرایش بیمه تامین اجتماعی -->
      ...
      <div class="provider-card card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white p-4 border-bottom-0">
          <div class="d-flex align-items-center gap-2">
            ...
            <h5 class="mb-0 font-weight-bold text-dark">بیمه سلامت</h5>
          </div>
        </div>
        <div class="card-body p-4">
          <div class="d-flex align-items-center justify-content-between">
