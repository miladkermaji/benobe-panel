  ...
  <div class="providers-content-option mt-4 d-flex justify-content-center align-content-center flex-column">
    <div class="top-providers-content d-flex justify-content-center mt-4 w-100">
      <div class="alert bg-light-blue w-100">
        <p>برای احراز هویت نسخه نویسی، کافیست یکبار برای همیشه اطلاعات مربوط به احراز هویت بیمه سلامت و تامین اجتماعی
          خود را
          وارد کنید.</p>
        <p>- اطلاعات کاربری تامین اجتماعی برای مرکز درمانی و مطب شخصی یکسان می باشد و با ورود کد نظام، کد ملی و شماره
          موبایل
          ثبت شده در سامانه تامین اجتماعی، احراز هویت کنید.</p>
        <p>- نام کاربری و رمز عبور شما در مطب و هر مرکز درمانی برای بیمه سلامت متفاوت است که آن را می توانید از سازمان
          بیمه
          سلامت دریافت کنید.</p>
        <p>- ممکن است برای احراز هویت بیمه سلامت رمز عبور دو مرحله ای داشته باشید که هر 24 ساعت یکبار، می بایست موقع
          نسخه
          نویسی، کد 5 رقمی پیامک شده را وارد کنید.</p>
      </div>
    </div>
    <div
      class="providers-cards d-flex gap-20 flex-xs-wrap flex-sm-wrap flex-md-nowrap flex-lg-nowrap justify-content-center">
        ...
        <div aria-hidden="true" class="d-flex align-items-center justify-content-between  w-100 p-3">
          <div>
            <div>
              ...
              <svg class="providerItem_center"data-toggle="modal" data-target="#exampleModalCenterAddSick"
        ...
        <div aria-hidden="true" class="d-flex align-items-center justify-content-between  w-100 p-3 ">
          <div>
            <div>
              ...
              <svg class="providerItem_centerInfo" data-toggle="modal" data-target="#exampleModalCenterEdit"
