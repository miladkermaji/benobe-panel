  ...
  <div class="patient-profile-details p-3 border">
    <div id="patient-profile-details-wrapper" class="d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex gap-10 align-items-center">
        <div>
          <svg class="cursor-pointer" data-toggle="modal" data-bs-target="#addToFavModalCenter" width="24"
        ...
        <div>
          <button data-toggle="modal" data-bs-target="#saveNoskheModalCenter" class="btn my-btn-primary h-50">نهایی سازی
            نسخه</button>
