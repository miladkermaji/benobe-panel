                  ...
                  <div
                    ...
                    <button class="selectDate_datepicker__xkZeS cursor-pointer text-center h-50  w-100 ">
                      <div class="d-flex justify-content-start w-100">
                        ...
                        <input type="text"
                          class="observer-example bg-transparent text-center cursor-pointer pwt-datepicker-input-element"
                          readonly="">
                      </div>
                    ...
                    <button class="selectDate_datepicker__xkZeS cursor-pointer text-center h-50  w-100 ">
                      ...
                      <div>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" class="calendar-svg-2"
                          xmlns="http://www.w3.org/2000/svg">
                          <rect x="2.63989" y="3.49097" width="15" height="14" rx="4" fill="#000"
                            fill-opacity="0">
                          </rect>
