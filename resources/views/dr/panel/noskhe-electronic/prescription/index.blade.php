...
<div class="prescription-wrapper">
  <div class="top-prescription-d w-100 mt-3">
    <div class="d-flex justify-content-between w-100 gap-20 align-items-center p-3">
      ...
      <div class="">
        <button class="btn btn-light h-50" data-toggle="modal" data-target="#exampleModalCenterAddSick">
  ...
  <div class="vakeshi-noskhe  p-3">
    <button class="btn btn-outline-secondary h-50" data-toggle="modal" data-target="#exampleModalCenterVakeshi">واکشی
      نسخه</button>
