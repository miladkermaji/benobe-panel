 ...
 <div class="d-flex justify-content-center align-items-center flex-column col-12">
   ...
   <div class="w-100 d-flex justify-content-start">
    <h5 class="font-weight-bold text-dark">شاخص‌های عملکرد <b>یاسر محمدی</b> 👋
     <div class="mt-4">🚀 <strong style="font-size: 24px;">امتیاز عملکرد شما: <span
        style="font-size: 32px; font-weight: bold; color: #FF0000;">46</span> از 100</strong><br>برای رشد رتبه و افزایش
      تعداد
     ...
     <div class="">
      ...
      <div class="">
       <div class="">با ارائه یک راه ارتباطی گفتگوی آنلاین، به بیماران فرصت مشورت و ویزیت غیر
        ...
        ندارند.<br> 👈 <a class="mt-2 text-primary" href="{{ route('activation.consult.rules') }}" target="_blank"
    ...
    <div class="p-3 w-100">
     <div class="">
      <p>
       ...
       <br>
       برای مثال میانگین فعلی تعداد نظر در گروه زنان بالای 150 نظر است. روند دریافت این نظرات باید طبیعی باشد. در صورت
       مشاهده یا
       گزارش هر رفتار مشکوک، احتمال ثبت جریمه روی صفحه شما وجود دارد.
       <br>
       از جمله روش‌های صحیح برای افزایش تعداد نظرات دریافتی، ثبت نوبت مراجعین حضوری در پذیرش۲۴ است. پذیرش۲۴ از این
       بیماران نظرسنجی
    ...
    <div class="p-3 w-100">
     <div class="">
      <p>
       ...
       <br>
       نکته: اگر به‌تازگی حساب خود در پذیرش۲۴ را باز کرده‌اید، پیشنهاد می‌کنیم علاوه بر ساعات شلوغ، در ساعات کم‌ترافیک
       که معمولاً
       پزشکان آنلاین کمتری هستند هم آنلاین باشید (مثل نیمه‌شب، صبح زود و روزهای تعطیل). این ساعات کم رقابت فرصت رشد شما
       را در
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      ...
      <br>
      مثلاً اگر نوبت دهی عصر شنبه شما در سایت فعال بوده و زمان نوبت خالی در آن دارید، برای بیماری که عصر شنبه به دنبال
      دکتر می
  ...
  <div class="option-card-box-shodow p-3 col-xs-12 col-sm-12  col-md-12 col-lg-8" id="personal-data">
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      بخش تلفن مطب در صفحه خود را بازبینی کنید و مطمئن شوید که فرمت صحیحی نوشته شده و بیمار با کلیک روی آن، می تواند با
      مطب تماس
      بگیرد.
      <br>
  ...
  <div class="option-card-box-shodow p-3 col-xs-12 col-sm-12  col-md-12 col-lg-8" id="personal-data">
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      معمولاً درمانگران، آخرین مدرک تحصیلی خود را ثبت میکنند. ولی این فرصت را دارید تا درجه علمی و تخصص‌های پایین‌تر را
      هم ثبت
      کنید.
      <br>
      مثلاً کاردانی، کارشناسی، پزشک عمومی و تخصص به همراه عنوان مستعار مرتبط با آن‌ها. این موضوع به بیمارانی که آن تخصص
      ها را
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      ...
      <br>
      استفاده از درجه علمی و تخصص‌هایی که معادل مدرک درمانی ندارید، مصداق فریب بیمار است. در صورت مشاهده و یا گزارش
      کاربران، حتی
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      ...
      <br>
      برای افزایش رضایت بیماران، صرفا درمان عالی اهمیت ندارد و حسی که بیمار از شرح حال گیری، صبوری، تجویز ،درمان، فالوآپ
      و پیگیری
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      ...
      <br>
      این تصویر اولین مواجهه بیمار با صفحه شماست و در جلب اعتماد وی تاثیر دارد. توصیه میکنیم عکس واضح با رزولیشن مناسب و
      تمام رخ
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      ...
      <br>
      توصیه می کنیم تصاویری از محیط معاینه، سالن انتظار و سایر تصاویری که به افزایش اعتماد بیماران کمک می کند با حفظ
      حریم خصوصی
      بیماران برای صفحه خود درج کنید.
      اگر در مجتمع های پزشکان یا درمانگاه ها هستید، تصاویر ورودی، طبقات و کروکی (برای راهیابی بهتر بیماران) فوق العاده
      اهمیت دارد.
      تصویر گواهی دوره های درمانی، مدارک و جوایز هم می توانند در گالری قرار بگیرند.
      <br>
      تصاویر باید با کیفیت و رزولوشن مناسب باشند. برای تغییر تصاویر گالری باید در زمانی که با حساب خود وارد شده اید، به
      صفحه عمومی
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      ...
      <br>
      لیست و هزینه خدمات درمانی حضوری خود را ثبت کنید. لیست هزینه پروسیجرها درمانی که جدای از هزینه ویزیت در مطب شما
      ارایه
  ...
  <div class="option-card-box-shodow p-3 col-xs-12 col-sm-12  col-md-12 col-lg-8" id="personal-data">
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      به نوبه روزانه محل مراجعه میلیون ها بیمار هست. این مراجعات مملو از فرصت های کشف نشده اند و حل مشکلات این بیماران
      کلید گسترش
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="p-3 w-100">
     <p>
      ...
      <br>
      این موضوع به تقویت ثبت نظرات در صفحه شما هم کمک می‌کند. برای مثال در بیو اینستاگرام خود لینک صفحه خود را قرار
      بدهید.
     </p>
    </div>
   </div>
