...
"undefined" != typeof document &&
    (function (e, t) {
        ...
        document,
        ':root{--swal-bg:#ffffff;--swal-text:#333333;--swal-border-radius:8px;--swal-shadow:0 4px 20px rgba(0,0,0,0.15);--swal-success:#28a745;--swal-error:#dc3545;--swal-warning:#ffc107;--swal-info:#17a2b8;--swal-question:#6c757d;--swal-button-bg:#007bff;--swal-button-hover:#0056b3;--swal-transition:all 0.3s ease}.swal2-popup.swal2-toast{flex-direction:column;align-items:stretch;width:auto;padding:1em;background:var(--swal-bg);border-radius:var(--swal-border-radius);box-shadow:var(--swal-shadow);overflow-y:hidden;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif}.swal2-popup.swal2-toast .swal2-header{flex-direction:row;padding:0}.swal2-popup.swal2-toast .swal2-title{flex-grow:1;justify-content:flex-start;margin:0 0.5em;font-size:1rem;font-weight:500;color:var(--swal-text)}.swal2-popup.swal2-toast .swal2-loading{justify-content:center}.swal2-popup.swal2-toast .swal2-input{height:2em;margin:0.25em auto;font-size:1rem;border-radius:4px;border:1px solid #e0e0e0}.swal2-popup.swal2-toast .swal2-validation-message{font-size:0.9rem;background:#f8d7da;color:var(--swal-error);padding:0.5em;border-radius:4px}.swal2-popup.swal2-toast .swal2-footer{margin:0.5em 0 0;padding:0.5em 0 0;font-size:0.85rem;color:#666}.swal2-popup.swal2-toast .swal2-close{position:static;width:0.8em;height:0.8em;line-height:0.8;color:#999;cursor:pointer;transition:var(--swal-transition)}.swal2-popup.swal2-toast .swal2-close:hover{color:var(--swal-error)}.swal2-popup.swal2-toast .swal2-content{justify-content:flex-start;margin:0 0.5em;padding:0;font-size:1rem;color:var(--swal-text);text-align:initial}.swal2-popup.swal2-toast .swal2-html-container{padding:0.5em 0 0}.swal2-popup.swal2-toast .swal2-html-container:empty{padding:0}.swal2-popup.swal2-toast .swal2-icon{width:1.5em;min-width:1.5em;height:1.5em;margin:0 0.5em 0 0}.swal2-popup.swal2-toast .swal2-icon .swal2-icon-content{display:flex;align-items:center;font-size:1.5em;font-weight:600}.swal2-popup.swal2-toast .swal2-icon.swal2-success .swal2-success-ring{width:1.5em;height:1.5em}.swal2-popup.swal2-toast .swal2-icon.swal2-error [class^=swal2-x-mark-line]{top:0.65em;width:1em;height:0.2em;background-color:var(--swal-error)}.swal2-popup.swal2-toast .swal2-icon.swal2-error [class^=swal2-x-mark-line][class$=left]{left:0.25em}.swal2-popup.swal2-toast .swal2-icon.swal2-error [class^=swal2-x-mark-line][class$=right]{right:0.25em}.swal2-popup.swal2-toast .swal2-actions{flex:1;align-self:stretch;width:auto;height:auto;margin:0.25em 0.25em 0;padding:0}.swal2-popup.swal2-toast .swal2-styled{margin:0.1em 0.25em;padding:0.3em 0.8em;font-size:0.95rem;border-radius:4px;transition:var(--swal-transition)}.swal2-popup.swal2-toast .swal2-styled:focus{outline:none;box-shadow:0 0 0 2px var(--swal-button-bg)}.swal2-popup.swal2-toast .swal2-success{border-color:var(--swal-success)}.swal2-popup.swal2-toast .swal2-success [class^=swal2-success-circular-line]{position:absolute;width:1.2em;height:2.4em;transform:rotate(45deg);border-radius:50%}.swal2-popup.swal2-toast .swal2-success [class^=swal2-success-circular-line][class$=left]{top:-0.6em;left:-0.4em;transform:rotate(-45deg);transform-origin:1.5em 1.5em;border-radius:3em 0 0 3em}.swal2-popup.swal2-toast .swal2-success [class^=swal2-success-circular-line][class$=right]{top:-0.2em;left:0.7em;transform-origin:0 1.2em;border-radius:0 3em 3em 0}.swal2-popup.swal2-toast .swal2-success .swal2-success-ring{width:1.5em;height:1.5em}.swal2-popup.swal2-toast .swal2-success .swal2-success-fix{top:0;left:0.35em;width:0.35em;height:2em}.swal2-popup.swal2-toast .swal2-success [class^=swal2-success-line]{height:0.25em}.swal2-popup.swal2-toast .swal2-success [class^=swal2-success-line][class$=tip]{top:0.85em;left:0.15em;width:0.6em}.swal2-popup.swal2-toast .swal2-success [class^=swal2-success-line][class$=long]{top:0.7em;right:0.15em;width:1em}.swal2-popup.swal2-toast.swal2-show{-webkit-animation:swal2-toast-show 0.5s;animation:swal2-toast-show 0.5s}.swal2-popup.swal2-toast.swal2-hide{-webkit-animation:swal2-toast-hide 0.2s forwards;animation:swal2-toast-hide 0.2s forwards}.swal2-container{display:flex;position:fixed;z-index:1060;top:0;right:0;bottom:0;left:0;flex-direction:row;align-items:center;justify-content:center;padding:0.625em;background-color:rgba(0,0,0,0.5);transition:background-color 0.2s;-webkit-overflow-scrolling:touch}.swal2-container.swal2-backdrop-show,.swal2-container.swal2-noanimation{background:rgba(0,0,0,0.5)}.swal2-container.swal2-backdrop-hide{background:transparent!important}.swal2-container.swal2-top{align-items:flex-start}.swal2-container.swal2-top-left,.swal2-container.swal2-top-start{align-items:flex-start;justify-content:flex-start}.swal2-container.swal2-top-end,.swal2-container.swal2-top-right{align-items:flex-start;justify-content:flex-end}.swal2-container.swal2-center{align-items:center}.swal2-container.swal2-center-left,.swal2-container.swal2-center-start{align-items:center;justify-content:flex-start}.swal2-container.swal2-center-end,.swal2-container.swal2-center-right{align-items:center;justify-content:flex-end}.swal2-container.swal2-bottom{align-items:flex-end}.swal2-container.swal2-bottom-left,.swal2-container.swal2-bottom-start{align-items:flex-end;justify-content:flex-start}.swal2-container.swal2-bottom-end,.swal2-container.swal2-bottom-right{align-items:flex-end;justify-content:flex-end}.swal2-popup{display:none;position:relative;box-sizing:border-box;flex-direction:column;justify-content:center;width:32em;max-width:100%;padding:1.5em;border-radius:var(--swal-border-radius);background:var(--swal-bg);box-shadow:var(--swal-shadow);font-family:inherit;font-size:1rem}.swal2-popup:focus{outline:none}.swal2-popup.swal2-loading{overflow-y:hidden}.swal2-header{display:flex;flex-direction:column;align-items:center;padding:0 1.5em}.swal2-title{position:relative;max-width:100%;margin:0 0 0.5em;padding:0;color:var(--swal-text);font-size:1.5rem;font-weight:600;text-align:center}.swal2-actions{display:flex;flex-wrap:wrap;align-items:center;justify-content:center;width:100%;margin:1em auto 0;padding:0}.swal2-styled.swal2-confirm{background-color:var(--swal-button-bg);color:#fff;border:none;border-radius:4px;padding:0.75em 1.5em;font-size:1rem;cursor:pointer;transition:var(--swal-transition)}.swal2-styled.swal2-confirm:hover{background-color:var(--swal-button-hover)}.swal2-styled.swal2-deny{background-color:var(--swal-error);color:#fff;border:none;border-radius:4px;padding:0.75em 1.5em;font-size:1rem;cursor:pointer}.swal2-styled.swal2-cancel{background-color:#6c757d;color:#fff;border:none;border-radius:4px;padding:0.75em 1.5em;font-size:1rem;cursor:pointer}.swal2-styled:focus{outline:none;box-shadow:0 0 0 2px var(--swal-button-bg)}.swal2-close{position:absolute;top:1em;right:1em;width:1.2em;height:1.2em;color:#999;font-size:1.5rem;cursor:pointer;transition:var(--swal-transition)}.swal2-close:hover{color:var(--swal-error)}.swal2-content{z-index:1;justify-content:center;margin:0;padding:0 1.5em;color:var(--swal-text);font-size:1.125rem;text-align:center}.swal2-icon{position:relative;justify-content:center;width:4em;height:4em;margin:1em auto 1.5em;border:0.15em solid transparent;border-radius:50%;font-family:inherit;line-height:4em}.swal2-icon.swal2-error{border-color:var(--swal-error);color:var(--swal-error)}.swal2-icon.swal2-success{border-color:var(--swal-success);color:var(--swal-success)}.swal2-icon.swal2-warning{border-color:var(--swal-warning);color:var(--swal-warning)}.swal2-icon.swal2-info{border-color:var(--swal-info);color:var(--swal-info)}.swal2-icon.swal2-question{border-color:var(--swal-question);color:var(--swal-question)}.swal2-icon .swal2-icon-content{display:flex;align-items:center;font-size:2.5em}.swal2-input,.swal2-textarea{box-sizing:border-box;width:100%;border:1px solid #e0e0e0;border-radius:4px;padding:0.75em;font-size:1rem;transition:border-color 0.3s}.swal2-input:focus,.swal2-textarea:focus{border-color:var(--swal-button-bg);outline:none;box-shadow:0 0 0 2px rgba(0,123,255,0.2)}.swal2-validation-message{background:#f8d7da;color:var(--swal-error);padding:0.75em;border-radius:4px;font-size:1rem}.swal2-toast-show{-webkit-animation:swal2-toast-show 0.5s;animation:swal2-toast-show 0.5s}.swal2-toast-hide{-webkit-animation:swal2-toast-hide 0.2s forwards;animation:swal2-toast-hide 0.2s forwards}.swal2-show{-webkit-animation:swal2-show 0.3s;animation:swal2-show 0.3s}.swal2-hide{-webkit-animation:swal2-hide 0.15s forwards;animation:swal2-hide 0.15s forwards}@-webkit-keyframes swal2-toast-show{0%{transform:translateY(-0.5em) scale(0.9);opacity:0}100%{transform:translateY(0) scale(1);opacity:1}}@keyframes swal2-toast-show{0%{transform:translateY(-0.5em) scale(0.9);opacity:0}100%{transform:translateY(0) scale(1);opacity:1}}@-webkit-keyframes swal2-toast-hide{100%{transform:scale(0.9);opacity:0}}@keyframes swal2-toast-hide{100%{transform:scale(0.9);opacity:0}}@-webkit-keyframes swal2-show{0%{transform:scale(0.7);opacity:0}100%{transform:scale(1);opacity:1}}@keyframes swal2-show{0%{transform:scale(0.7);opacity:0}100%{transform:scale(1);opacity:1}}@-webkit-keyframes swal2-hide{0%{transform:scale(1);opacity:1}100%{transform:scale(0.7);opacity:0}}@keyframes swal2-hide{0%{transform:scale(1);opacity:1}100%{transform:scale(0.7);opacity:0}}@-webkit-keyframes swal2-rotate-loading{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}@keyframes swal2-rotate-loading{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}body.swal2-shown:not(.swal2-no-backdrop):not(.swal2-toast-shown){overflow:hidden}body.swal2-no-backdrop .swal2-container{background-color:transparent!important;box-shadow:none}body.swal2-toast-shown .swal2-container{background-color:transparent}'
    );
